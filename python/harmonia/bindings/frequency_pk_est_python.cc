...
void bind_frequency_pk_est(py::module &m) {
  ...
  py::class_<frequency_pk_est, gr::block, gr::basic_block,
      ...
      .def(py::init(&frequency_pk_est::make), py::arg("nfft"),
           ...
           py::arg("NLLS_iter"), py::arg("NLLS_pts"), D(frequency_pk_est, make))
      ...
      .def("set_metadata_keys", &frequency_pk_est::set_metadata_keys,
           py::arg("fft_size_key"), D(frequency_pk_est, set_metadata_keys))
