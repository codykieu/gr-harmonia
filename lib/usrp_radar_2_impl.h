...
#ifndef INCLUDED_HARMONIA_USRP_RADAR_2_IMPL_H
#define INCLUDED_HARMONIA_USRP_RADAR_2_IMPL_H
...
namespace gr
{
  namespace harmonia
  {
    ...
    class usrp_radar_2_impl : public usrp_radar_2
    {
    private:
      // Block params
...
#endif /* INCLUDED_HARMONIA_USRP_RADAR_2_IMPL_H */
