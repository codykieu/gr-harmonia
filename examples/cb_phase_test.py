...
# Title: Clock Bias and Phase test
# Author: cody
...
class cb_phase_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Clock Bias and Phase test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Clock Bias and Phase test")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "cb_phase_test")
        ...
        self.plasma_lfm_source_0 = plasma.lfm_source(bw, -bw/2 + center_freq, Tp, samp_rate, 0)
        ...
        self.harmonia_usrp_radar_all_0 = harmonia.usrp_radar_all("addr=192.168.60.2, use_dpkg=1", "addr=192.168.80.2, use_dpkg=1", samp_rate, samp_rate, center_freq, center_freq, 20, 20, 0.005, Tc, 1, 2e-6, False)
        ...
        self.harmonia_time_pk_est_0.set_backend(plasma.Device.DEFAULT)
        self.harmonia_clockbias_phase_est_0 = harmonia.clockbias_phase_est(3, 1, 1e6, center_freq, samp_rate, Tp, 0)
        ...
        self.msg_connect((self.harmonia_clockbias_phase_est_0, 'out'), (self.blocks_message_debug_0_0, 'print'))
        self.msg_connect((self.harmonia_time_pk_est_0, 'tp_out'), (self.blocks_message_debug_0, 'print'))
        ...
        self.msg_connect((self.plasma_lfm_source_0, 'out'), (self.plasma_pdu_file_sink_0_0_0, 'in'))
...
def main(top_block_cls=cb_phase_test, options=None):
