...
class USRP_TX_RX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "USRP_TX_RX")
        ...
        self.harmonia_usrp_radar_2_0 = harmonia.usrp_radar_2("addr=192.168.60.2, use_dpkg=1", "addr=192.168.80.2, use_dpkg=1", samp_rate, samp_rate, center_freq, center_freq, 10, 10, 0.1, False, "", False)
        self.harmonia_usrp_radar_2_0.set_metadata_keys('core:tx_freq', 'core:rx_freq', 'core:sample_start', 'radar:prf')
        self.harmonia_single_tone_src_0 = harmonia.single_tone_src(1e6, 0, 100e-6, samp_rate, 0)
        ...
        self.msg_connect((self.harmonia_usrp_radar_2_0, 'out'), (self.qtgui_time_sink_x_0_0, 'in'))
