...
class single_tone_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "single_tone_test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("single_tone_test")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "single_tone_test")
        ...
        self.plasma_lfm_source_0 = plasma.lfm_source(5e6, 0, 10e-6, samp_rate, 0)
        ...
        self.plasma_cw_to_pulsed_1 = plasma.cw_to_pulsed(10e3, samp_rate)
        self.plasma_cw_to_pulsed_1.init_meta_dict('core:sample_rate', 'radar:prf')
        self.harmonia_pdu_complex_to_mag_0 = harmonia.pdu_complex_to_mag()


        ##################################################
        # Connections
        ##################################################
        self.msg_connect((self.harmonia_pdu_complex_to_mag_0, 'out'), (self.qtgui_time_sink_x_0, 'in'))
        self.msg_connect((self.plasma_cw_to_pulsed_1, 'out'), (self.harmonia_pdu_complex_to_mag_0, 'in'))
        self.msg_connect((self.plasma_cw_to_pulsed_1, 'out'), (self.qtgui_time_sink_x_1_1, 'in'))
        self.msg_connect((self.plasma_lfm_source_0, 'out'), (self.plasma_cw_to_pulsed_1, 'in'))
...
def main(top_block_cls=single_tone_test, options=None):
